<?php
require_once dirname(__FILE__) . DIRECTORY_SEPARATOR . "Ahosti_response.php";

/**
 * Ahosti API processor
 *
 * Documentation on the Ahosti API: http://manage.Ahosti.com/kb/answer/744
 *
...
class AhostiApi {
	 ...
	 * @return AhostiResponse The response object
	 */
	public function submit($command, array $args = array(), $method = "POST") {
		...
		curl_close($ch);
		return new AhostiResponse($response);
	}
